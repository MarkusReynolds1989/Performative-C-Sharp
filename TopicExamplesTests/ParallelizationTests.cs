...
public class ParallelizationTests
{
    ...
    public void AllStringsAreNumbersShort()
    {
        ...
        // simultaneously.
        var results = Parallelization.StringsToIntegers(_shortFile.Length, _shortFile).ToList();
    }
    ...
    public void AllStringsAreNumbersParallelShort()
    {
        ...
        var results = Parallelization.StringsToIntegersParallel(_shortFile.Length, _shortFile).ToList();
    }

    [Fact]
    //[Fact(Skip="Enable manually, will take a long time.")]
    public void AllStringsAreNumbersLong()
    {
        ...
        var results = Parallelization.StringsToIntegers(_longFile.Length, _longFile).ToList();
    }
    ...
    public void AllStringsAreNumbersParallelLong()
    {
        ...
        var results = Parallelization.StringsToIntegersParallel(_longFile.Length, _longFile).ToList();
    }

    //[Fact(Skip="Enable manually, will take a long time.")]
    [Fact]
    public void AllStringsAreNumbersParallelLinq()
    {
        var results = Parallelization.StringsToIntegersParallelLinq(_longFile).ToList();
    }
}